...
from scene_2e_opposite import CarCrossOppositeScene
...
SCENE_CLASSES = {
    ...
    '2d': CarCrossScene,
    '2e': CarCrossScene,
    '2e_opposite': CarCrossOppositeScene,
...
def main():
    ...
    parser.add_argument('--town', type=str, default=None, help='Town name (default: auto-detect from JSON)')
    ...
    parser.add_argument('--max_scenario_time', type=float, default=12.0,
    ...
    # Auto-detect town from the first JSON file if --town not specified
    if args.town is None:
        first_doc = load_scenario_document(scenario_files[0])
        args.town = next(iter(first_doc.keys()))
        print(f"[AUTO] Detected town: {args.town} from scenario file")
